...
class LocalAntOptimizer: public CLColonyOptimizer {
protected:
	cl::Program program;
	cl::KernelFunctor<
...
public:
	static constexpr const char* static_name = "localant";
	static constexpr const char* static_params = "";

	LocalAntOptimizer(Problem problem, AntParams params)
	...
	void prepare() override {
		setupCL(true);
		program = loadProgram("./src/variants/localant.cl");
