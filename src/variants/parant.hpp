...
class ParAntOptimizer: public CLColonyOptimizer {
protected:
	cl::Program program;
	cl::KernelFunctor<
...
public:
	static constexpr const char* static_name = "parant";
	static constexpr const char* static_params = "";

	ParAntOptimizer(Problem problem, AntParams params)
	...
	void prepare() override {
		setupCL(true);
		program = loadProgram("./src/variants/parant.cl");
