...
class NeighborOptimizer: public CLColonyOptimizer {
protected:
	cl::Program program;
	cl::KernelFunctor<
...
public:
	static constexpr const char* static_name = "neighbor";
	static constexpr const char* static_params = "";

	NeighborOptimizer(Problem problem, AntParams params)
	...
	void prepare() override {
		setupCL(true);
		program = loadProgram("./src/variants/neighbor.cl");
