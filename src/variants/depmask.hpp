...
class DepMaskOptimizer: public CLColonyOptimizer {
protected:
	cl::Program program;
	cl::KernelFunctor<
...
public:
	static constexpr const char* static_name = "depmask";
	static constexpr const char* static_params = "";

	DepMaskOptimizer(Problem problem, AntParams params)
	...
	void prepare() override {
		setupCL(true);
		program = loadProgram("./src/variants/depmask.cl");
